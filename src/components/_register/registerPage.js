...
export default function RegisterPage()
{
    ...
    const registerPending = useSelector(state => state.registerReducer.registerPending);
    ...
    const handleSubmit = (e) => {
        ...
        if (user_name && user_password && user_email) {
            dispatch(authAction.onRegister(formData));
        } 
    }
        ...
        <div>
            ...
            <Grid style={{ height: '70vh' }} verticalAlign='center'>
                ...
                <Header as='h3' color='red' textAlign='center'>
                    <Image size="mini" src={siteMeta.logo} /> Sign Up to Moviepedia
                </Header>

                    <Form name="form" size='large' onSubmit={handleSubmit} loading={registerPending} >
                        ...
                        <Segment> 
                            ...
                            <Form.Input
                                ...
                                id='form-input-user_email'
                                error={submitted && !user_email && ({content:"E-Mail is required"})}  
                            />
                            ...
                            <Button primary size='large' loading={registerPending} fluid>Kayıt Ol</Button>
                        </Segment>
                    </Form>

                    <Message>
                        Üye misiniz?  <Link to="/login"> Giriş Yapın</Link>
                    </Message>
                </Grid.Column>
            </Grid>
            </Container>
